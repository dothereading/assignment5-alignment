...
def run_zero_shot_math(model: str = "Qwen/Qwen2.5-Math-1.5B"):
    import sys
...
def main(model: str = "Qwen/Qwen2.5-Math-1.5B"):
    import json
    from datetime import datetime

    result = run_zero_shot_math.remote(model=model)
    ...
    for out_path in [results_dir / "results.json", results_dir / f"results_{timestamp}.json"]:
